// formConfig
import { validateMail, validateId, validateMobile, validateName, validateNumeric, validateUsername, validateZip } from "../utilities/validator.js"
...
[
    ...
    {name: "password", type: "password", validator: (val) => val.length > 8/*validatePassword*/, placeholder: "password"},
